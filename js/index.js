...
$(function(){
    ...
    var page = {
        ...
        shareImg:'',
        activeStatus:'ends',
        shareTitle: '【咿啦说】第20期 李芳老师： 30分钟让您的宝贝学会勇敢',
        shareDesc: '',
        flag: true,
        isInApp:false,
        mobileType:'',
        ...
        initEvent: function () {
            ...
            if (w.activeStatus === 'ends') {
                w.$.title_btn.text('本期回顾');
                w.$.title_btn.click(function(){
                    window.location.href = w.isInApp ? './ellaSay.020.html' : 'https://a.app.qq.com/o/simple.jsp?pkgname=com.ellabook';
                });
            } else {
